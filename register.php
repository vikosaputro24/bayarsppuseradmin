...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_sql = "INSERT INTO tb_login (fullname, username, email, password)
    ...
    <div class="bg-dark bg-opacity-90 p-5 rounded-lg shadow-lg w-80">
        ...
        <form action="register.php" method="POST">
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control pl-5" name="fullname" placeholder="Masukkan Nama" required>
                <i class="fas fa-user-tie left"></i>
            </div>
            <div class="form-group mb-3">
