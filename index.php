...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-secondary text-white" href="">Pengumuman</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item d-lg-none">
                        <div class="dropdown text-center">
                            <button class="nav-link btn btn-outline-secondary dropdown-toggle text-white" type="button"
                                id="mobileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                Profile
                            </button>
    ...
    <section id="home" class="d-flex align-items-center"
        style="height: 100vh; background-image: url('./assets/p.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; text-align: center; position: relative;">
